...
def setup(browser):
    """
    Browser setup settings: authorizes new user.

    :param browser: Selenium.webdriver with fixture 'browser' settings.
    :return: True if new user was authorized, esle - False.
    """
    ...
    page.register_new_user(email, password, page)
    page.should_be_authorized_user()


def get_random_string(length):
    """
    Gets random string to use for generating new user's email and password.
...
def test_product_page_is_valid(browser):
